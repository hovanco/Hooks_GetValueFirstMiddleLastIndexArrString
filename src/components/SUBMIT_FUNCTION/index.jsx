...
import { getFirstMiddleLastValue } from "../HANDLE_STRING_FUNCTION";
...
function SUBMIT_FUNCTION() {
  ...
  const handleSubmit = (event) => {
    ...
    setResult(getFirstMiddleLastValue(stringInput).replaceAll(",", "")); // xoa dau , in object-array [6,7,8]
  };
      ...
      <div className="panel panel-danger">
        <div className="panel-heading">
          <h3 className="panel-title">
            ARRAY STRING INPUT - SHOW FIRST INDEX, MIDDLE INDEX, LAST INDEX
          </h3>
        </div>
